...
#        self.setMaximumSize(400,400)
        ...
        self.FeederScanstepTextbox.setValue(1500)
        self.FeederScanstepTextbox.setSingleStep(500)
...
#        StageMoveContainer.setMaximumWidth(200)
        ...
        self.ObjMotor_current_pos_Label = QLabel("Current pos.: ")
...
#        self.SetAndMoveNextCoordsButton.clicked.connect(self.SetFocusPos)        
        ...
        self.layout.addWidget(self.EmitCoordsButton, 4, 2)
    ...
    def GenerateScanCoords(self):
        if self.SetStageScanCoordsButton.isChecked():
            ...
            step = int(self.FeederScanstepTextbox.value()) #length of each step, 1500 for -5~5V FOV

...
Rawimgbef = imread(r'D:\XinMeng\3.tif', as_gray=True)#(r"O:\Delft\data\PMT__2019-11-08_14-55-56.tif", as_gray=True)
Rawimgaft = imread(r'D:\XinMeng\10.tif', as_gray=True)#(r"O:\Delft\data\PMT__2019-11-08_14-55-56.tif", as_gray=True)

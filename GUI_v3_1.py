...
class MyWindow(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        Layout.addWidget(QLabel("Start index-column:"), 0, 6)      
    ...
    def get_login(self):
        ...
        if kk.exec_():
            self.analogwave = kk.analogcontainer_array
            self.digitalwave = kk.digitalcontainer_array
            self.readin = kk.readinchan
            self.samplingrate = int(kk.textboxAA.currentText())
